...
Copyright (C) 2018-2026 Foswiki Contributors. Foswiki Contributors
...
jQuery(function($) {
   $(".jqParticles").livequery(function() {
      ...
      //console.log("particles opts=",opts);

      particles = Particles.init(opts);
      $this.data("Particles", particles).on("click", function() {
